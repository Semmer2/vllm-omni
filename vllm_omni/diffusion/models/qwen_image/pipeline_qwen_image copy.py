...
class QwenImagePipeline(
    ...
    def forward(
        ...
        if do_true_cfg:
            #print(prompt_embeds.shape)#1,12,2584
            #print(prompt_embeds_mask.shape)#1,12
            ...
            #print(negative_prompt_embeds.shape)#1,5,3584
            #print(negative_prompt_embeds_mask.shape)#1,5
        ...
        if output_type == "latent":
            ...
            #print(image.shape)#1,3,1024,1024
